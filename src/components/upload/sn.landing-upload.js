...
function SnLandingUpload(props) {
  ...
  const download = () => {
    try {
      const skylink = parseSkylink(userSkylink)
          ...
          <div className="main-cntner">
            <div className="row main-rw-row-div">
              ...
              <div className="col col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 firstColumn">
                {/* col 1 title */}
                <div className="colum1-title-div">
                  Upload Your
                  {isDirUpload ? "Directory" : "Files"}
                </div>
                {/* drag n drop col 1 */}
                ...
                <div className="butn-upld-col1-toggle-div">
                  <button
                    className="btn  btn butn-upld-col1"
                    onClick={(evt) =>
                      uploadEleRef.current.gridRef.current.click(evt)
                    }
                  >
                    ...
                    >
                      <span className="input-group-text icon-inpt-colum2">
                        ...
                        <div className="srch_btn_main_div_changed">
                          <i className="fa fa-download colum2-icon-dwnload" />
                        </div>
                      </span>
                    </div>
                  </div>
